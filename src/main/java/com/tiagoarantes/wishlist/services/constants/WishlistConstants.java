...
public class WishlistConstants {
    ...
    public static final String PRODUCT_NOT_FOUND = "Produto não encontrado na lista de desejo do cliente";
    public static final String PRODUCT_FOUND = "Produto encontrado na lista de desejo do cliente";
}
